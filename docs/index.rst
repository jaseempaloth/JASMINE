...
* Linear and logistic regression models with JAX acceleration
* KNN and SVM classifiers
* Preprocessing utilities (standard scaling and one-hot encoding)
* Synthetic dataset generators for regression and classification
* Train/test split helpers and model metrics
